...
public class JobPostActivity {
	...
	public JobPostActivity(Integer jobPostId, Users postedById, JobLocation joblocationId, JobCompany jobCompanyId, @Length(max = 10000) String descriptionOfJob, String jobType,
	...
	public String toString() {
		return "JobPostActivity [jobPostId=" + jobPostId + ", postedById=" + postedById + ", joblocationId="
				+ jobLocationId + ", jobCompanyId=" + jobCompanyId + ", descriptionOfJob=" + descriptionOfJob
